...
VALUES
    ...
    ('Emil', 'Zola', 'ezola@requim.com'),
    ('Sissy', 'Coalpits', 'scoalpits@greenaway.com'),
    ('Antoinette', 'Capet', 'capet@dontloseyourhead.com'),
    ('Samuel', 'Delaney', 'sdelaney@dhalgren.com'),
    ('Tony', 'Duvert', 'tduvert@frenchletters.com'),
    ('Dennis', 'Cooper', 'dcooper@georgemiles.com'),
    ('Monica', 'Bellucci', 'mbellucci@irreversible.net'),
    ('Samuel', 'Johnson', 'sjohnson@boswell.com'),
    ('John', 'Dryden', 'jdryden@restoration.net'),
    ('Alexander', 'Pope', 'apope@ucambridge.uk.edu'),
    ('Lionel', 'Johnson', 'ljohnson@darkangel.net'),
    ('Aubrey', 'Beardsley', 'abeardsley@wilde.net'),
    ('Tulse', 'Looper', 'tlooper@films.net'),
    ('William', 'Morris', 'wmorris@victroiana.net'),
    ...
    ('Arthur', 'Machen', 'amach@spirits.net'),
    ...
    ('Anthony', 'Trollope', 'atrollope@barchster.com'),
    ('Charlotte', 'Yong', 'cyong@newday.com'),
    ('Horace', 'Walpole', 'hwal@toranto.net'),
    ...
    ('Hubert', 'Crackenthorpe', 'hcracken@goodletters.com'),
    ('William', 'Carleton', 'hcarleton@literature.com'),
    ('Gerald', 'Griffen', 'ggriff@lit.net');

    INSERT INTO votes (voter_id, candidate_id)
    VALUES (3, 1), (4, 2), (5, 2), (6, 2), (7, 2), (8, 3), (9, 3),
    (10, 5), (11, 3), (12, 4), (13, 3), (16, 7), (17, 1), (18, 4),
    (19, 5), (20, 3), (21, 2), (22, 3), (23, 4), (24, 4), (25, 7);